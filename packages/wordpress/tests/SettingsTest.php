...
final class SettingsTest extends TestCase
{
    ...
    public function saving_with_a_blank_key_field_keeps_the_existing_key(): void
    {
        ...
        $result = $settings->sanitize(['pixel_id' => 'px-1', 'capi_key' => '']);
    ...
    public function an_invalid_integration_source_falls_back_to_the_default(): void
    {
        ...
        // rather than stored.
        $result = (new Settings())->sanitize(['integration_source' => 'not valid!']);
    ...
    {
        $result = (new Settings())->sanitize(['canonical_origin' => 'javascript:alert(1)']);
